...
//! | Sequence | Struct |
//! |----------|--------|
//! | `CSI ? Pm s` | [`mode::SaveTerminalModes`] |
//! | `CSI ? Pm r` | [`mode::RestoreTerminalModes`] |
//!
//! Note: Individual mode Save/Restore structs are generated by the `terminal_mode!` macro.
//! For example, `SaveCursorVisibility` (`CSI ? 25 s`) and `RestoreCursorVisibility` (`CSI ? 25 r`)
//! are generated alongside `EnableCursorVisibility`, `DisableCursorVisibility`, etc.
//!
//! ## mouse
//!
//! | Sequence | Struct |
